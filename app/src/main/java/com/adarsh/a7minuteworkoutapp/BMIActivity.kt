...
import com.adarsh.a7minuteworkoutapp.databinding.ActivityBmiBinding
...
//            customDialogForBackButton()
    ...
    private fun displayBMIResult(bmi:Float){
          ...
          if (bmi.compareTo(15f) <= 0){
              ...
              bmilevel="Obsess Class | (Moderately Obsessed)"
              bmiDescription = "Oops! You really need to take better care of Yourself! Workout More!"
          }else if(bmi.compareTo(35f)>0 && bmi.compareTo(40f)<=0){
              bmilevel="Obsess Class | (Severly Obsessed)"
              bmiDescription = "Oops! You really need to take better care of Yourself! Workout More!"
          }else{
              bmilevel="Obsess Class | ( Very Severly Obsessed)"
              bmiDescription = "Oops! You really need to take better care of Yourself! Workout More!"
          }
        ...
        binding?.tvBMIType?.text = bmilevel
    ...
    private fun calculateUnits(){
            ...
            if (currentVisibleView == METRIC_UNITS_VIEW){
                if (validateMetricUnits()){
                    ...
                    Toast.makeText(this, "Please input the correct values", Toast.LENGTH_SHORT).show()
                }
            }else{
                try{if (validateUsUnits()){
                    ...
                    Log.e("Error in btn","Something in US  went wrong")
                }
